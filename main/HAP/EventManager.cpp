...
int EventManager::ListenerList::sendEvent( int eventCode, struct HAPEvent param )
{
...
mNumEvents( 0 )
{
    for ( int i = 0; i < kEventQueueSize; i++ )
    {
        ...
        mEventQueue[i].param = HAPEvent();
    }
}



boolean EventManager::EventQueue::queueEvent( int eventCode, struct HAPEvent eventParam )
{
    /*
...
boolean EventManager::EventQueue::popEvent( int* eventCode, struct HAPEvent* eventParam )
{
    /*
