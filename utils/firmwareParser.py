...
regex_homie = re.compile(b"\x25\x48\x4f\x4d\x45\x4b\x49\x54\x5f\x45\x53\x50\x33\x32\x5f\x46\x57\x25")
...
md5_returned = hashlib.md5(firmware_binary).hexdigest()

print("Name:    {0}".format(name))
print("Version: {0}".format(version))
print("Brand:   {0}".format(brand))
print("md5:     {0}".format(md5_returned))
